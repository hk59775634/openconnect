...
struct oc_ip_info {
	...
	/* Dynamic Split Tunnel domain lists (AnyConnect / ocserv-tunnel SPEC-02).
	 * Populated from X-CSTP-Post-Auth-XML; route strings are malloc'd. */
	struct oc_split_include *dynamic_split_includes;
	struct oc_split_include *dynamic_split_excludes;
